...
export const primaryButton = `${font.oswald} ${glow.cta} inline-flex min-h-14 w-full items-center justify-center bg-[#ff6418] px-5 text-center text-[clamp(1rem,3.2vw,1.15rem)] font-black uppercase tracking-normal text-white transition duration-200 hover:-translate-y-0.5 hover:bg-[#ff7a2c] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#ff6418] md:w-auto md:min-w-72`;

export const secondaryButton = `${font.oswald} inline-flex min-h-14 w-full items-center justify-center border-2 border-white/90 px-5 text-center text-[clamp(1rem,3.2vw,1.15rem)] font-black uppercase tracking-normal text-white transition duration-200 hover:-translate-y-0.5 hover:border-[#ff6418] hover:text-[#ff6418] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#ff6418] md:w-auto md:min-w-72`;
